...
public class NoticeSearchActionController implements Action {
...
//		한 페이지에서 나오는 페이지 버튼의 개수
		...
		noticeDAO.selectAll(searchMap).stream().map(member -> new JSONObject(member)).forEach(jsons::put);
