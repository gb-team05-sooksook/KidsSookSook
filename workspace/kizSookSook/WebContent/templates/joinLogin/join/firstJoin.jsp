	...
	<div class="global-body">
		<div id="master-body">
			<div class="MasterBodyDeskTop">
				<div id="router-view" style="margin-top: 0px;">
					<div class="SignupPage">
						<div class="container-1170">
							...
							<section class="flex-center-center margin-bottom-100">
								<div class="AuthCard" style="padding: 56px 80px;">
	                        		...
	                        		<div class="border-top-dashed-gray">
	                        			<a class="flex-center-center btn btn-default width-100 NGM button-signup" style="background-color: rgb(255, 212, 0); border-color: rgb(255, 212, 0);">
	                        				<span onclick="location.href='${pageContext.request.contextPath}/secondJoin.member'" style="font-size: 15px; font-weight: 600;">이메일로 가입하기</span>
	                        			</a>
	                        		</div>
                        		</div>
                       		</section>
