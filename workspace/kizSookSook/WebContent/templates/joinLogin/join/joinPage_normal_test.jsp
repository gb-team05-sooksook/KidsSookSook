            ...
            <div class="main-join-box">
                <form novalidate="" class="join-form" id="joinForm" action="${pageContext.request.contextPath}/joinPage_normalAction.member">
                    ...
                    <div class="join-item-div">
                        ...
                        <div >
                            <div class="error-div">
                                <p class="error-text error-id checkText error-test"></p>
                            </div>
                        </div>
                    </div>
                    <div class="join-item">
                        ...
                        <div class="join-item-input-div">
                            ...
                            <div>
                                <div class="error-div">
                                    <p class="error-text error-test"></p>
                                </div>
                            </div>
                        <div class="join-item-div">
                            <div class="join-item-input-div">
                    ...
                    <div class="join-item-div">
                        ...
                        <div >
                            <div class="error-div">
                                <p class="error-text checkText error-test"></p>
                            </div>
                        </div>
                    </div>
                    <div class="join-item-div">
...
<script src="${pageContext.request.contextPath}/static/js/joinLogin/join/joinPageNormal.js"></script>
</html>