								...
								<ul class="page-number-wrapper">
									<c:if test="${prev}">
										<li class="page-left-arrow">
											<button onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=1&categoryName=science&page=${startPage - 1}'" class="page-left-arrow-button-wrapper">
									...
									<c:if test="${next}">
										<li class="page-right-arrow">
											<button onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=1&categoryName=science&page=${endPage + 1}'" class="page-right-arrow-button-wrapper">
