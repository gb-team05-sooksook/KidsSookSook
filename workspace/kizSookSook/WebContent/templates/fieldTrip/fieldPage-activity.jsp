                        ...
                        <div class="category-right-listNames">
                            <div class="category-right-listName-turn">
								<div id="btn-item" class="category-right-listName-turn-name">
                                    <p id="item1" class="selectBold" onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=4&categoryName=activity&sort=recent'">최신순</p>
                                </div>
                                <div id="btn-item" class="category-right-listName-turn-name">
                                    <p id="item2" onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=4&categoryName=activity&sort=popular'">추천순</p>
                                </div>
                            </div>
                        </div>
                        <!-- 체험학습 리스트 -->
								...
								<ul class="page-number-wrapper">
									<c:if test="${prev}">
										<li class="page-left-arrow">
											<button onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=4&categoryName=activity&page=${startPage - 1}&sort=${param.sort}'" class="page-left-arrow-button-wrapper">
									...
									<c:if test="${next}">
										<li class="page-right-arrow">
											<button onclick="javascript:location.href='${pageContext.request.contextPath}/connectCategoryPageAction.fieldTrip?categoryId=4&categoryName=activity&page=${endPage + 1}&sort=${param.sort}'" class="page-right-arrow-button-wrapper">
