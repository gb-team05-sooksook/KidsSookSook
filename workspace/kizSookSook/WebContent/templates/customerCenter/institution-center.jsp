            ...
            <div class="category-container">
                <div class="category-content">
                    <header class="page-header">
                        <h1>
                            <div class="page-title">기관안내 센터</div>
                        </h1>
                    </header>
                        ...
                        <section class="section">
                            ...
                            <ul class="article-list">
                                <li class="article-list-item article-promoted">
                                    ...
                                    <a href="" class="article-list-link">[공지] TEST (2023.02.21)</a>
                                </li>
                                <li class="article-list-item article-promoted">
                                    <span data-title="승격된 문서" class="icon-star"></span>
                                    <a href="" class="article-list-link">[업데이트] TEST (2023.02.21)</a>
                                </li>

                                <li class="article-list-item article-promoted">
                                    <span data-title="승격된 문서" class="icon-star"></span>
                                    <a href="" class="article-list-link">[자료·템플릿] TEST (2023.02.21)</a>
                                </li>
                                    ...
                                    <a href="">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" focusable="false"
                                            ...
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-width="2" d="M5 14.5l6.1-6.1c.2-.2.2-.5 0-.7L5 1.5"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li class="section-list-item">
                                    <a href="">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" focusable="false"
                                            viewBox="0 0 16 16" aria-hidden="true">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-width="2" d="M5 14.5l6.1-6.1c.2-.2.2-.5 0-.7L5 1.5">
                                            </path>
                                        </svg>
                                    </a>
                                </li>
                        ...
                        <section class="section">
                            ...
                            <ul class="article-list">
                                <li class="article-list-item">
                                    <a href="" class="article-list-link">[콘텐츠 지원] 전문가님, 윤디자인 폰트를 15% 할인된 가격으로
                                        사용해보세요!</a>
                                </li>
                                <li class="article-list-item">
                                    <a href="" class="article-list-link">[공간지원]세미나 · 강연은 Happy 라운지 어떠세요?</a>
                                </li>
                            </ul>
                        </section>
