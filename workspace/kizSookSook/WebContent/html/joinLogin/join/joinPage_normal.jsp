        ...
        <main class="main-box">
            ...
            <div class="main-join-box">
                <form novalidate="" class="join-form">
                    ...
                    <div class="join-item-div">
                        <div class="join-item-title">직업</div>
                        <div class="join-item-select-container">
                            ...
                            <div class="join-item-select-control">
                                <div class="join-item-select-div-inner">
                                    <div class="join-item-select-placeholder">직업을 선택해 주세요.</div>
                                    <input id="react-select-2-input" readonly="" tabindex="0" aria-autocomplete="list" class="join-item-select-dummyinput" value="">
                                </div>
