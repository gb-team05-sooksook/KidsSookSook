                        ...
                        <form id="new_request" class="request-form" data-form="" data-form-type="request" action=""
                            ...
                            <div class="form-field string required request_anonymous_requester_email">
                                ...
                                <input type="text" name="request[anonymous_requester_email]"
                                    id="request_anonymous_requester_email" aria-required="true" class="change">
                            ...
                            &quot;value&quot;:&quot;고객의소리/제보&quot;},{&quot;label&quot;:&quot;제휴&quot;,&quot;value&quot;:&quot;제휴&quot;}]" aria-required="true"
                                    aria-describedby="request_custom_fields_360018466731_error"
                                    aria-labelledby="request_custom_fields_360018466731_label">
                                <a class="nesty-input" tabindex="0" aria-haspopup="true" aria-expanded="false"
                                    aria-controls="_zxpwwg7jl" aria-required="true"
                                    aria-labelledby="request_custom_fields_360018466731_label" style="max-width: 100%;">
                                    -
                                </a>
                                <div id="request_custom_fields_360018466731_error"
                                    class="notification notification-error notification-inline">
                                    상담유형: 반드시 입력해야 합니다.
                                </div>
                            ...
                            <div class="form-field string  required  request_subject">
                                ...
                                <input type="text" name="request[subject]" id="request_subject" maxlength="150"
                                    size="150" aria-required="true" aria-labelledby="request_subject_label"
                                    class="change">
                            ...
                            <div class="form-field text  required  request_description">
                                ...
                                <textarea name="request[description]" id="request_description" aria-required="true"
                                    ...
                                    aria-labelledby="request_description_label" class="change"></textarea>
                                <input type="hidden" name="request[description_mimetype]"
                                    id="request_description_mimetype" value="text/plain" autocomplete="off" class="">
                            ...
                            <div class="form-field">
                                ...
                                <ul id="request-attachments-pool" class="upload-pool" data-template="upload-template">
                                </ul>
                            </div>
                            <footer>
