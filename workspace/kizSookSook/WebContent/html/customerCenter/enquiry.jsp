            ...
            <div class="form">
                <form id="new_request" class="request-form" data-form="" data-form-type="request"
                    ...
                    <div class="form-field string  required  request_custom_fields">
                        ...
                        <input type="hidden" name="request[custom_fields]" id="request_custom_fields" autocomplete="off"
                            value="">
                    ...
                    <div class="form-field text  required  request_description">
                        ...
                        <textarea name="request[description]" id="request_description">
                        </textarea>
                    ...
                    <div class="form-field">
                        ...
                        <div id="upload-dropzone" class="upload-dropzone">
                            <input type="file" id="request-attachments" >
                            <span>
