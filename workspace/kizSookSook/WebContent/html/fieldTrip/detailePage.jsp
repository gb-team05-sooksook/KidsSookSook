...
<!-- 별점 -->			<section class="detaile-left-star">
						...
						<div class="star-score-next">113개의 평가</div>
					</section>
...
<!-- 체험 평가 -->	<section class="field-evaluation">
					<div class="field-evaluation-containal">
						...
						<div class="field-evaluation-wrapper">
							...
							<div class="field-evaluation-star-score">5.0</div>
								...
								<div class="review-list-person">
									...
									<div class="review-list-person-profile-next">
										...
										<div class="review-list-person-profile-star-containal">
											<div class="review-list-person-profile-star-wrapper">
												<svg class="review-list-person-profile-star"></svg>
												<div class="review-list-person-profile-star-containel">
													<svg viewBox="0 0 24 24" class="widget-svg" style="width: 15px; height: 15px; transition: transform 0.2s ease-in-out 0s;">
														<path class="star" d="M8.37094152,8.12482574 L2.52598096,8.59636398 L2.36821881,8.6135218 C0.881583763,8.81867772 0.513822851,10.1467426 1.72605142,11.1443161 L6.11068071,14.7526934 L4.80553251,20.0682859 L4.77348322,20.2161997 C4.50052597,21.673724 5.6402616,22.4726949 6.9887771,21.699537 L12.00271,18.8250573 L17.0166429,21.699537 L17.1506515,21.7715841 C18.4829447,22.4403279 19.5680516,21.5674348 19.1998875,20.0682859 L17.8937294,14.7526934 L22.2793686,11.1443161 L22.3984321,11.0405714 C23.4954951,10.0270601 23.0352205,8.72174778 21.479439,8.59636398 L15.6334685,8.12482574 L13.3880977,3.09014615 C12.7393731,1.6361626 11.2656405,1.63707337 10.6173223,3.09014615 L8.37094152,8.12482574 Z" style="fill: rgb(255, 212, 0); transition: fill 0.2s ease-in-out 0s;"></path>
													</svg>
												</div>
												<div class="review-list-person-profile-star-containel">
											...
											<span class="review-list-person-score">5.0</span>
											<div class="review-list-person-score-next">|</div>
...
한번 더 왔습니다.
				...
				<div class="fix">
	<!-- 오른쪽 -->	<aside class="right-page">
						<section class="right-first-section">
							<button class="right-first-section-link">
								<span class="right-first-section-link-img">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet" class="right-first-section-link-img-place">
