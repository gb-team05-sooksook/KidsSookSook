...
<!DOCTYPE html>	
	...
	<link rel="stylesheet" href="/kizSookSook/css/fieldTrip/detailePage.css">
	<link rel="stylesheet" href="/kizSookSook/font/font.css">
	<link rel="icon" href="/kizSookSook/resources/img/logo/icon.png">
	</head>
	<body>
		<div>
	...
	<!-- 이미지 -->		<section class="detaile-left-img">
							<img src="/kizSookSook/resources/img/fieldTrip/fieldPage/science/Science1-1.jpg" width="100%">
						</section>
								...
								<div class="review-list-containal">
									<div class="review-list-person">
										<div class="review-list-person-profile">
											<img src="/kizSookSook/resources/img/fieldTrip/detailePage/techer.png" class="review-list-person-profile-img">
										</div>
	...
	<script src="/kizSookSook/js/fieldTrip/detailePage.js"></script>
	</body>
	</html>